...
class LSimple_senales(object):
    ...
    def generar_xml(self, diccionario):
        ...
        archivo_guardar = eg.filesavebox(msg="Guardar archivo XML",
                                         title="Guardar XML",
                                         default='D:/rec nery/rec nery/Desktop/Nery José Barrientos/Segundo Semestre 2023/ipc2/IPC2_Proyecto1_201807086/Archivos de Salida/*xml',
    ...
    def graph_generate(self, nombre_buscar):
        if self.vacio():
            print('Lista Vacia')
        else:
            validar = True
            ...
            n = 1
            while validar:
                if aux.nombre == nombre_buscar:
                    aux.frecuencias.generar_grafico(aux.nombre,aux.t,aux.a)
                n += 1
                if aux == self.ultimo:
                    validar = False
                else:
    ...
    def graph_generate_reducida(self, nombre_buscar):
        if self.vacio():
            print('Lista Vacia')
        else:
            validar = True
            ...
            while validar:
                if aux.nombre == nombre_buscar:
                    aux.reducida.generar_grafico_reducida(aux.nombre,aux.a)
                n += 1
                if aux == self.ultimo:
                    validar = False
                else:
    ...
    def borrar(self):
        # Borra todos los elementos de la lista de senales
        self.primero = None
        self.ultimo = None